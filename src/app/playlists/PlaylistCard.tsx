    ...
    <div className="w-full backdrop-blur-lg bg-[var(--white)]/5 rounded-xl p-4 sm:p-10
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {genres.map((g) => (
          <span
            key={g}
            className="text-xs bg-[var(--green)]/10 text-[var(--green)]
      ...
      <div className="flex flex-col justify-center gap-3 mt-8">
        <Link href={youtubeLink} target="_blank" className="flex-1 flex items-center gap-2">
          <button className="flex items-center rounded-lg bg-teal-400/10 hover:bg-teal-700/10
                             px-3 py-1 hover:text-[var(--green)] text-xl font-medium
                             leading-5 text-[var(--light-green)]">
            <FaYoutube className="m-1" />
            <span className="text-xs text-[var(--lightest-slate)]">Ver en YouTube</span>
          </button>
        </Link>
        ...
        <Link href={spotifyLink} target="_blank" className="flex-1 flex items-center gap-2">
          <button className="flex items-center rounded-lg bg-teal-400/10 hover:bg-teal-700/10
            ...
            <span className="text-xs text-[var(--lightest-slate)]">Escuchar en Spotify</span>
          </button>
        </Link>
